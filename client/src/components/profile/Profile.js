...
const Profile = ({user, resetPassword}) => {
  ...
  return (
    <section>
      <div className="profile" style={{height:"93vh"}}>
        <div className="profile-inner">
          ...
          <div class="card-container">
            ...
            <button onClick={modalShow} style={{color: "black", marginTop:13, borderRadius: 10}} className="btn btn-warning">
              Change password
            </button>
          </div>
          </div>
      ...
      <ResetPassword showModal={showModal} onChange={onChange} modalClose={modalClose} onClickChangePassword={onClickChangePassword}/>
    </section>
  )
}
